...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2025 a las 01:07:32
...
--
-- Base de datos: `tienda en lineaa`
--
...
--
ALTER TABLE `direcciones`
  ADD CONSTRAINT `direcciones_ibfk_1` FOREIGN KEY (`usario_id`) REFERENCES `usuarios` (`id`);
